package com.none.xmall.admin.component;

import com.none.xmall.admin.bo.WebLog;
import com.none.xmall.admin.util.JsonUtil;
import com.none.xmall.admin.util.RequestUtil;
...
public class WebLogAspect {
    ...
    @Pointcut("execution(public * com.none.xmall.controller.*.*(..))")
    public void webLog() {
    }
